...
The =Xmodmap= file will be used with the =xmodmap= program to remap CapsLock to Ctrl inside of our desktop enviroment:

*Although written, currently not used in this configuration. Using setxkbmap instead of xmodmap see Launcher Script*
...
*Commented out because better functionality with Polybar*
*** Time and date
